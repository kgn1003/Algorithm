...
vector<pair<pair<int, int>,int>> pos[4] = {
	{ {{-1,-1},10},{{-1,0},7},{{-1,1},1},{{-2,0},2},{{0,-2},5},{{1,-1},10},{{1,0},7},{{1,1},1},{{2,0},2}}, // 좌
{{{-1,-1},1},{{0,-1},7},{{0,-2},2},{{1,-1},10},{{2,0},5},{{1,1},10},{{0,1},7},{{0,2},2},{{-1,1},1}}, // 하
{{{-1,-1},1},{{-1,0},7},{{-1,1},10},{{-2,0},2},{{0,2},5},{{1,-1},1},{{1,0},7},{{1,1},10},{{2,0},2}}, // 우
{{{-1,-1},10},{{0,-1},7},{{1,-1},1},{{0,-2},2},{{-2,0},5},{{1,1},1},{{0,1},7},{{0,2},2},{{-1,1},10}} // 상
};
